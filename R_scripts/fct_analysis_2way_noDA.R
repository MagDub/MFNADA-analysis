...
rm_anova_MF_noDA <- function(x1, x2) {
  ...
  dataMF <- read_excel("~/GoogleDrive/UCL/MF/analysis/stats/data_for_R/thomp_3_params_like_param_recovery_Q0norm_no506_noDA.xlsx")    
