...
rm_anova_MF_LH_score <- function(x1, x2, x3, x4, x5, x6) {
  ...
  dataMF <- read_excel("~/GoogleDrive/UCL/MF/analysis/stats/data_for_R/thomp_3_params_like_param_recovery_Q0norm_no506.xlsx", sheet = "scoreLH")    
  ...
  sentence1=paste(
    ...
    "; PANAS_NA-by-sample interaction: F(",
